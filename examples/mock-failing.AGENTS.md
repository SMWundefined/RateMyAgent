...
`empty_string`, `very_long_string` did not return an error from the target (`failing-mock`) -- they
killed the connection. Affected tools: `echo`.
...
**FINDING: 6 schema-forbidden inputs accepted**
...
often failed to survive was `connection_refused`.
...
<!-- ratemyagent-state
{
  "generated_at": "2026-09-09T05:28:51+00:00",
  "metrics": {
    "accepted_invalid": 6,
    "crashes": 2,
